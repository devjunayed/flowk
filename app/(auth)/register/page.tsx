      ...
      <div className="relative w-full max-w-md bg-[#0a1813]/90 backdrop-blur-md border border-[#5DCAA5]/20 rounded-2xl p-8 animate-[fadeUp_0.5s_ease_both]">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs text-[#e1f5ee]/60">Full name</label>
            <input
              type="text"
              value={name}
              ...
              required
              className="px-3 py-2.5 rounded-lg bg-white/5 border border-[#5DCAA5]/20 text-sm text-[#e1f5ee] placeholder:text-[#e1f5ee]/30 focus:outline-none focus:border-[#5DCAA5]/50 focus:bg-[#5DCAA5]/5"
            />
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            {strength && (
              <div className="flex items-center gap-2 mt-1">
                <div className="flex-1 h-[3px] rounded bg-[#5DCAA5]/20 overflow-hidden">
                  <div
                    className={`h-full transition-all
                      ${strength === 'weak' && 'w-1/3 bg-[#F0997B]'}
                      ${strength === 'medium' && 'w-2/3 bg-[#FAC775]'}
                      ${strength === 'strong' && 'w-full bg-[#5DCAA5]'}
                    `}
                  />
                </div>
                <span className="text-[11px] text-[#e1f5ee]/40 min-w-[50px]">
                  {strength === 'strong' ? 'Strong' : strength === 'medium' ? 'Good' : 'Too short'}
                </span>
              </div>
            )}
          </div>
        ...
        {/* Terms */}
        <p className="text-xs text-center text-[#e1f5ee]/30 mt-4 leading-relaxed">
          By signing up you agree to our{' '}
          <Link href="/terms" className="text-[#5DCAA5] hover:text-[#9FE1CB]">
            Terms
          </Link>{' '}
          and{' '}
          <Link href="/privacy" className="text-[#5DCAA5] hover:text-[#9FE1CB]">
            Privacy Policy
          </Link>.
        </p>

        {/* Footer */}
        <p className="text-center text-sm text-[#e1f5ee]/40 mt-3">
          Already have an account?{' '}
          <Link href="/login" className="text-[#5DCAA5] hover:text-[#9FE1CB]">
            Sign in
          </Link>
        </p>
